...
const tourArray = ['#bubble-intro', '#scale-container', '#top-container', '#solar-group', '#display-container', '#power-button', '#delete-button', '#memory-recall', '#memory-minus', '#memory-plus', '#equals-button', '#bubble-outro' ]
